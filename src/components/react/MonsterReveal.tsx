...
export default function MonsterReveal({ children, title }: MonsterRevealProps) {
  ...
  return (
    <div onClick={handleClick} className={`relative rounded-2xl bg-white/50 border-2 border-gray-200 p-8 shadow-2xl shadow-black/40 transition duration-500 ${isBlurred ? 'cursor-pointer' : 'cursor-auto'} hover:shadow-md dark:border-gray-700 dark:bg-white/5`}>
