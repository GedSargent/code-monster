...
This response will be sent back to the client and later accessed in the page itself via the `useLoaderData` hook we have seen [previously](/code-monster/guides/light-and-dark-mode/02-adding-a-loader-function).
