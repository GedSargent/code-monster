...
Let's make sure our project is set up correctly before we start building our application.

The instructions below are all found in the project [**README File**](https://github.com/BSc-Web-Apps/epic-news/blob/main/README.md), but these are reproduced here for your convenience.
...
4. Finally, from the terminal again, type:
...
![Initial landing screen](src/assets/webp/epic-news-next/initial-landing-screen.webp)
