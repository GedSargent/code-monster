...
```diff lang="tsx" title="app/components/organisms/HeaderWithSearch.tsx" showLineNumbers ins="{ isAdminUser }: HeaderWithSearchProps" ins="flex flex-1 items-center justify-center gap-8" collapse={32-50}
...
Feel free to open this file and see if you can work out where the user is created.
