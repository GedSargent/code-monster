...
1. Put back the valid CSRF token in `app/root.tsx` so that the login functionality works again.
2. What other forms do we have in the application. Can you add CSRF protection to them?
