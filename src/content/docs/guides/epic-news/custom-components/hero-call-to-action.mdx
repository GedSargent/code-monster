...
Open the component file at `app/components/organisms/Hero/HeroCallToAction.tsx` if you haven't already.

If you look inside the `HeroCallToAction` component code, you will see that it has an [**`interface`**](https://prismic.io/blog/typescript-interfaces) defined at the top of the file.
