...
1. First, `import` the `ParallaxProvider` at the top of your `app/root.tsx` file:
...
<MonsterReveal title="1. ⚙️ Component configuration">
...
<MonsterReveal title="2. 🎨 Customise component">
