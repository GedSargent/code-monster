...
Finally, let's replace the mock `articles` array with all the real articles from our database.

::::tip[Challenge]

Can you swap out the old mock `articles` array with the new `allArticles` array yourself?
