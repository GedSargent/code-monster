...
To understand more about the `ArticleGetPayload` type, see [Prisma's documentation](https://www.prisma.io/docs/orm/prisma-client/type-safety/operating-against-partial-structures-of-model-types).
