...
Well, it doesn't look great, but at least we can see the first article's image, title and category displayed on the page:
...
### Simplifying code: object destructuring
