...
```
With this code saved, your `news/$category` should look something like this:
...
At least we can see the first article's image, title and category displayed on the page. We will improve the styling later.
