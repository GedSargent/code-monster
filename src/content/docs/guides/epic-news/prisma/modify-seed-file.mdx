...
2. Download the new seed file by clicking the link below:
		...
		<a href="/code-monster/downloads/epic-news/seed.ts" download="seed.ts" class="group inline-flex border-2 gap-4 mt-8 px-8 py-4 text-xl rounded-full no-underline transition bg-blue-200 border-blue-400 hover:border-blue-600 hover:bg-blue-100 dark:bg-blue-600 dark:border-blue-400 dark:hover:border-blue-300 dark:hover:bg-blue-700">
			<Icon name="seti:markdown" class="fill-blue-600 transition group-hover:scale-125 group-hover:fill-blue-800 dark:fill-blue-100 dark:group-hover:fill-blue-50" /> <span class="text-blue-600 transition group-hover:text-blue-800 dark:text-blue-100 dark:group-hover:text-blue-50">seed.ts</span>
		</a>
...
4. Drag the downloaded `seed.ts` file into the `prisma` folder in your project.
