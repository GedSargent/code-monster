...
<MonsterVideo
	src="https://www.youtube.com/embed/NXqEP_PsPNc?si=_mUaoXuvBJs6Enoe"
	title="Remix loader function"
/>
...
You'll notice the `loader` function is being passed a `params` object as an [argument](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Functions#passing_arguments) here:
