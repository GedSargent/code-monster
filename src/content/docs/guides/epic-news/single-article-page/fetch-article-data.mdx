...
Using your knowledge from our previous lesson on how to [**load and display articles**](/code-monster/guides/epic-news/displaying-articles/load-and-display-article-data) for the news index page, can you fetch and display the article data for the single article page?
...
```diff lang="tsx" title="app/routes/article.$articleId.tsx" showLineNumbers collapse={28-36}
import { invariant } from '@epic-web/invariant'
import { type LoaderFunctionArgs, data, useLoaderData } from 'react-router'
import { prisma } from '~/utils/db.server.ts'
...
```diff lang="tsx" title="app/routes/article.$articleId.tsx" showLineNumbers collapse={1-24}
import { invariant } from '@epic-web/invariant'
import { type LoaderFunctionArgs, data, useLoaderData } from 'react-router'
import { prisma } from '~/utils/db.server.ts'
