...
As we looked at in the [`Outlet` component lesson](/code-monster/guides/outlet), Remix uses a file-based routing system. This means that the file structure of your project maps directly to the URL structure of your app.
