...
<MonsterReveal>
  <div>
    ...
    ![Category migration warning](src/assets/png/prisma/article-migration-warning.png)
...
![Prisma Studio with Category table](src/assets/png/prisma/prisma-studio-article-table.png)
