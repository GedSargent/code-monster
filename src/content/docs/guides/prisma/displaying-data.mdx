...
To fix this problem, many developers now use [**TypeScript**](https://www.typescriptlang.org/), and this is the language Remix has adopted.

TypeScript is built on top of JavaScript, and lets us annotate code with descriptions of what our variables, objects and functions should look like. This means that we can catch bugs like the one above while we are still coding, long before any customers see it.
