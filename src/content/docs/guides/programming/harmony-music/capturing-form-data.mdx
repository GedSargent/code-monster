...
Open the `index.js` file, and look carefully at the [comment plan](/code-monter/guides/programming/harmony-music/comment-planning) you created in the [previous guide](/code-monter/guides/programming/harmony-music/comment-planning).
...
```diff lang="javascript" name="index.js" showLineNumbers collapse={12-20}
// Capture user's input on form submission
let form = document.querySelector("form");
...
1. Target the user's *level* and *hours of study* in the same way as we did for the email address. Give your variables suitable names that are consistent with our first variable name.
...
```diff lang="javascript" title="index.js" showLineNumbers ins={", userLevel, userHours"} collapse={13-21}
// Capture user's input on form submission
let form = document.querySelector("form");
...
If you need a reminder of how to commit your changes in Github Desktop, you can refer back to the [committing to GitHub](/code-monter/guides/programming/harmony-music/committing-to-github) guide.
...
We also need to update our assignment document to reflect the latest changes to our project.

Open your assignment document and update it with the latest changes to your project.

:::note

Remind yourself of the things needed in the assignment by referring back to the [assignment update](/code-monter/guides/programming/harmony-music/assignment-update) guide.
