...
In the next step, we will learn how to commit your current code changes to GitHub using GitHub Desktop.

This will allow you to save your work and keep track of the changes you've made.