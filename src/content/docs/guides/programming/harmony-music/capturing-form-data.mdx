...
Remind yourself of the things needed in the assignment by referring back to the [assignment update](/code-monster/guides/programming/harmony-music/assignment-update) guide.
